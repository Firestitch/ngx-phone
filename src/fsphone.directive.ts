...
import {Directive, Input, ElementRef, OnInit, Renderer2, Output, EventEmitter, OnChanges} from '@angular/core';
import {BACKSPACE, DELETE, HOME} from '@angular/cdk/keycodes';
import {FsPhoneConfigInterface} from './interfaces/';
...
export class FsPhoneDirective implements OnChanges {
  ...
  @Input('fsPhoneConfig') public fsPhoneConfig: FsPhoneConfigInterface = {
    maskType: 'us',
    mask: null
  };
